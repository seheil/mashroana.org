...
export const DONATION_ADVISOR_EXPERTISE = [
  "يفهم مبالغ التبرع بالأرقام العربية وبعبارات مثل «ألف جنيه» و«نصف ألف».",
  "يقترح مبالغ صحيحة مجموعها يساوي قيمة التبرع، ولا يكتفي بالنسب العامة.",
  "يفضّل الأولويات المنشورة والمعتمدة من الإدارة، ولا يصف أي حالة بالعاجلة دون نشرها.",
  "يستخدم توزيعاً متوازناً معلناً عند غياب أولوية مؤقتة، ويصرّح بذلك بوضوح.",
  "لا يؤكد التحويل المالي؛ يوجّه إلى القنوات الرسمية ويطلب الاحتفاظ بالإيصال والتواصل عند الحاجة.",
  "يحترم خصوصية المستفيدين ولا يطلب بيانات شخصية حساسة من المتبرع داخل المحادثة.",
];
...
- العنوان: 39 شارع علي قاسم، حدائق المعادي، القاهرة`,
  ...
  },
  {
    ...
    answer: "يعتمد الاختيار على هدفك وعلى الأولويات المعتمدة وقت التبرع. إذا نشرت الإدارة أولوية مؤقتة، يقترح المساعد مبلغاً دقيقاً لها مع سببها. وعند عدم وجود أولوية منشورة، يقدّم توزيعاً متوازناً ولا يصف أي برنامج بأنه الأشد احتياجاً.",
    category: "donation-guidance",
  },
  {
    id: "exact-donation-split",
    question: "كيف يقترح المساعد تقسيم مبلغ التبرع؟",
    answer: "أرسل قيمة المبلغ مثل: «أريد التبرع بألف جنيه». إذا كانت المؤسسة نشرت أولويات معتمدة، يقسم المساعد المبلغ عليها بمبالغ دقيقة. وعند عدم وجود أولوية منشورة، يقدّم توزيعاً متوازناً معلناً ولا يصف أي برنامج بأنه الأشد احتياجاً.",
    category: "donation-guidance",
  },
  {
    id: "priority-notices",
    question: "كيف أعرف الأولويات الحالية؟",
    answer: "تظهر الأولويات في الصفحة الرئيسية وفي إجابة المساعد فقط عندما تنشرها الإدارة بعد مراجعة سببها ومصدرها. عند غياب أولوية معتمدة، لا يعرض الموقع تنبيهاً أو حالة عاجلة افتراضية.",
    category: "transparency",
  },
  {
    id: "donation-confirmation",
    question: "هل فتح رابط التبرع يعني تأكيد التحويل؟",
    answer: "لا. فتح رابط InstaPay أو أي قناة رسمية لا يؤكد التحويل. بعد التحويل احتفظ بالإيصال، وتواصل مع المؤسسة عبر WhatsApp أو الهاتف إذا احتجت توجيهاً أو متابعة.",
    category: "donation-safety",
  },
  {
    id: "school-preparation",
    question: "هل توجد أولوية للمدارس أو المستلزمات الدراسية؟",
    answer: "عندما تعتمد المؤسسة احتياجاً مدرسياً، تضيفه الإدارة كأولوية موسمية مع الوصف والعدد والمستهدف إن كانت موثقة. حينها يظهر التنبيه ويستخدمه المساعد في اقتراح التوزيع. لا نفترض وجود حملة قبل اعتمادها.",
    category: "seasonal",
  },
];
